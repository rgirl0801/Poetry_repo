...
print("-" * 40 + " MANAGER " + "-" * 40)
print(
    f"Manager {manager.name} is {manager.age} years old,"
...
print(
    f"Employee {employee1.name} is {employee1.age} years old,"
...
print(
    f"Employee {employee2.name} is {employee2.age} years old,"
